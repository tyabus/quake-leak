...
int I_FileWrite (int handle, void *src, int count)
{
...
void I_FileSeek (int handle, int position)
{
	lseek (handle, position, SEEK_SET);
}

int I_FileRead (int handle, void *dest, int count)
{
...
int main (int c, char **v)
{
	...
	parms.memsize = 0x1000000;
	parms.membase = malloc (parms.memsize);
	parms.basedir = "/usr/tmp/lquake/";
